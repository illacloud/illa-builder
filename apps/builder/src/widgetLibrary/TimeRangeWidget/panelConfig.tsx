...
export const TIME_RANGE_PANEL_CONFIG: PanelConfig[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        labelDesc: i18n.t("editor.inspect.setter_tips.time_range.start_placeholder"),
      ...
      },
      {
        ...
        labelDesc: i18n.t("editor.inspect.setter_tips.time_range.end_placeholder"),
        isSetterSingleRow: true,
      ...
      },
      {
        ...
        labelDesc: i18n.t('editor.inspect.setter_tips.time_picker.the_span_of_the_valu'),
        attrName: "minuteStep",
        setterType: "INPUT_SETTER",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        labelDesc: i18n.t('editor.inspect.setter_tips.time_picker.show_a_clear_button_'),
        attrName: "showClear",
        useCustomLayout: true,
        setterType: "DYNAMIC_SWITCH_SETTER",
        openDynamic: true,
