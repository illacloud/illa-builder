...
export const RANGE_SLIDER_PANEL_CONFIG: PanelConfig[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        labelName: i18n.t("editor.inspect.setter_tips.slider.maximum"),
        labelDesc: i18n.t("editor.inspect.setter_label.slider.maximum"),
        attrName: "max",
        expectedType: VALIDATION_TYPES.NUMBER,
        setterType: "INPUT_SETTER",
      },
      {
        ...
        labelName: i18n.t("editor.inspect.setter_tips.slider.step_size"),
        labelDesc: i18n.t("editor.inspect.setter_label.slider.step_size"),
        attrName: "step",
        expectedType: VALIDATION_TYPES.NUMBER,
        setterType: "INPUT_SETTER",
      },
