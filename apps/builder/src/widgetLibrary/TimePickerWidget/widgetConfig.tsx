import { ReactComponent as TimePickerWidgetIcon } from "@/assets/widgetCover/timePicker.svg"
...
export const TIME_PICKER_WIDGET_CONFIG: WidgetConfig = {
  ...
  defaults: {
    placeholder: i18n.t("editor.inspect.setter_default_value.time_picker.select_time"),
    format: "HH:mm:ss",
    minuteStep: "{{15}}",
    colorScheme: "blue",
    label: "Label",
