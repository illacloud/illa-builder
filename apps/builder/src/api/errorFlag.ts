export enum ERROR_FLAG {
  ...
  // new
  ERROR_FLAG_INVALIED_OAUTH_AGENCY,
  ERROR_FLAG_EXCHANGE_OAUTH_TOKEN_FAILED,
  ERROR_FLAG_OAUTH_FETCH_USER_INFO_FAILED,
  ERROR_FLAG_USER_PASSWORD_NOT_SETTED,
  ERROR_FLAG_OAUTH_CONNECT_FAILED,
  ERROR_FLAG_CAN_NOT_START_TRANSACTION,
  ERROR_FLAG_CAN_NOT_GET_TRANSACTION,
  ERROR_FLAG_CAN_NOT_COMMIT_TRANSACTION,
  ERROR_FLAG_CAN_NOT_CANCEL_TRANSACTION,
  ERROR_FLAG_CAN_NOT_GET_CAPACITY,
  ERROR_FLAG_INVALIED_TRANSACTION_SERIAL_MODIFY_TARGET,
  ERROR_FLAG_INVALIED_TRANSACTION_SERIAL_MODIFY_METHOD,
  ERROR_FLAG_CAN_NOT_RETRIEVE_TRANSACTION,
  ERROR_FLAG_CAN_NOT_WRITE_QUEUE,
  ERROR_FLAG_CAN_NOT_GET_CUSTOMER,
  ERROR_FLAG_NO_PAYMENT_INFO,
  ERROR_FLAG_CAN_NOT_GET_PORTAL_PAGE_URL,
  ERROR_FLAG_CAN_NOT_CREATE_CUSTOMER,
  ERROR_FLAG_CAN_NOT_SUBSCRIBE_THIS_PLAN,
  ERROR_FLAG_CAN_NOT_GET_SUBSCRIPTION,
  ERROR_FLAG_SUBSCRIPTION_ALREADY_EXISTS,
  ERROR_FLAG_SUBSCRIPTION_PLAN_ILLEGAL,
  ERROR_FLAG_CAN_NOT_GENERATE_CHECKOUT_SESSION_URL,
  ERROR_FLAG_CAN_NOT_PURCHASE_THIS_ITEM,
  ERROR_FLAG_PURCHASE_ITEM_ILLEGAL,
  ERROR_FLAG_MODIFY_SUBSCRIPTION_FAILED,
  ERROR_FLAG_CANCEL_SUBSCRIPTION_FAILED,
  ERROR_FLAG_CAN_NOT_GET_REQUEST_BODY,
  ERROR_FLAG_WEBHOOK_SIGNATURE_VERIFICATION_FAILED,
  ERROR_FLAG_ILLEGAL_WEBHOOK_EVENT,
  ERROR_FLAG_INIT_REST_API_FAILED,
  ERROR_FLAG_CANCEL_TRANSACTION_FAILED,
  ERROR_FLAG_CAN_NOT_CREATE_SUBSCRIPTION,
  ERROR_FLAG_COMMIT_TRANSACTION_FAILED,
  ERROR_FLAG_ILLEGAL_SUBSCRIPTION,
  ERROR_FLAG_ILLEGAL_PRICE_ID,
  ERROR_FLAG_CAN_NOT_GET_CAPACITY_RECORD,
  ERROR_FLAG_CAN_NOT_INIT_REST_API,
  ERROR_FLAG_UPDATE_CAPACITY_FAILED,
  ERROR_FLAG_CAN_NOT_CALCULATE_MODIFIED_VALUE,
  ERROR_FLAG_CAN_NOT_GET_SESSION,
  ERROR_FLAG_CAN_NOT_RESET_CAPACITY,
  ERROR_FLAG_CAN_NOT_UPDATE_SUBSCRIPTION,
  ERROR_FLAG_BUILD_TEAM_MEMBER_CONFIG_FAILED,
  ERROR_FLAG_CAN_NOT_GET_UPCOMING_INVOICE,
  ERROR_FLAG_CAN_NOT_INCREASE_TEAM_MEMBER_DUE_TO_NO_BALANCE,
  ERROR_FLAG_INVALIED_AUTHORIZATOIN_TOKEN,
  ERROR_FLAG_CAN_NOT_GENERATE_AUTHORIZATION_TOKEN,
  ERROR_FLAG_ILLEGAL_WEBHOOK_TOKEN,
  ERROR_FLAG_INVALIED_REQUEST,
  ERROR_FLAG_TARGET_USER_ALREADY_APPLIED_APPSUMO,
  ERROR_FLAG_CAN_NOT_ENHANCE_TIER,
  ERROR_FLAG_INVALIED_ACTION,
  ERROR_FLAG_DO_NOT_HAVE_APPSUMO_PLAN,
  ERROR_FLAG_APPSUMO_PLAN_ALREADY_APPLIED,
  ERROR_FLAG_CAN_NOT_DELETE_SUBSCRIPTION,
  ERROR_FLAG_APPSUMO_PLAN_ILLEGAL,
  ERROR_FLAG_CAN_NOT_REMOVE_TEAM_MEMBER_BECAUSE_APPSUMO_BUYER,
  ERROR_FLAG_CAN_NOT_UPDATE_TEAM_MEMBER_ROLE_BECAUSE_APPSUMO_BUYER,
  ERROR_FLAG_INSUFFICIENT_TEAM_LICENSE,
}
